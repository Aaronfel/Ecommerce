    ...
    return (
        <>
            <form onSubmit={(e) => !editando ? guardarProducto(e) : confirmarEdicion(e)} className="contenedorFormPrdocutos" action="">
                ...
                <div className="itemForm">
                    <label className="textareaLabelForm" htmlFor="descripcionChicha">Descrpición chica</label>
                ...
                <div className="itemForm">
                    <label className="textareaLabelForm" htmlFor="descripcionGrande">Descripción grande</label>
                ...
                <div className="itemForm">
                    <label className="item-label" htmlFor="stcok">Stock</label>
            ...
            </form>
            {
                mostrarExito ?
                    <div className="w-75">
                        <Alert className="alert" severity="success">Agregado con éxito!</Alert>
                    </div>
                    : ""
            }
