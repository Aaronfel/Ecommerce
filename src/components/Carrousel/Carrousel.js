...
import imagenSuper1 from '../../assets/img/imagenSuper_1.jpg'
import imagenSuper2 from '../../assets/img/imagenSuper_2.jpg'
import imagenSuper3 from '../../assets/img/imagenSuper_3.jpg'
const Carrousel = () => {
    return (
        <>
